		...
		if(!state.used[index/4][index%4]){
			if(!state.selected[index]) {
				if(state.nUnused < 1 && state.nUsed < 1) {
					...
					if(state.playerturn == 1) this.setImageResource(R.drawable.sample_1);
					if(state.playerturn == 2) this.setImageResource(R.drawable.sample_2);
				...
				this.setImageResource(R.drawable.sample_0);
			...
			if(state.nUnused < 2) {
				if(!state.selected[index]) {
					if(state.nUsed < 2 && state.nUnused < 1) {
						state.selected[index] = true;
						if(state.board.tables[index/4].table[index%4] == 1) this.setImageResource(R.drawable.sample_2);
						if(state.board.tables[index/4].table[index%4] == 2) this.setImageResource(R.drawable.sample_1);
						if(state.choice1 != -1 && state.choice2 == -1) state.choice2 = index;
						if(state.choice1 == -1)	state.choice1 = index;
						state.nUsed++;
					}
					...
					if(state.board.tables[index/4].table[index%4] == 1) this.setImageResource(R.drawable.sample_1);
					if(state.board.tables[index/4].table[index%4] == 2) this.setImageResource(R.drawable.sample_2);
					if(state.choice1 == index) state.choice1 = -1;
					if(state.choice2 == index) state.choice2 = -1;
					state.nUsed--;
				}
